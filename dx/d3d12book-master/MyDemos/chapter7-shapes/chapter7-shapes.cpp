...
void ShapesApp::BuildShapeGeometry()
{
    ...
    GeometryGenerator::MeshData skull = geoGen.CreateFromFile("Models/skull.txt");
    ...
    for (size_t i = 0; i < skull.Vertices.size(); ++i, ++k)
    {
        ...
        vertices[k].Color = XMFLOAT4(DirectX::Colors::SeaGreen);
    }
...
void ShapesApp::BuildRenderItems()
{
    ...
    XMStoreFloat4x4(&skullRitem->World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, -6.3f, 1.0f));
