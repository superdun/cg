...
private:
	...
	void ClipPipeline();
	ModelInstance* ClipInstance(const ModelInstance* instance, const std::array< std::array<double, 4>, 4>& matrix_model_camera);
	ModelInstance* ClipInstanceAgainstPlane(const ModelInstance* instance, const std::array<double, 3>& instanceBSCenterPoint, const double instanceBSRadius, const Plane* plane, const std::array< std::array<double, 4>, 4>& matrix_model_camera);
	ModelInstance* ClipTrianglesAgainstPlane(const ModelInstance* instance, const std::array< std::array<double, 4>, 4>& matrix_model_camera);
	Triangle* ClipTriangleAgainstPlane(const Triangle* triangle, const std::array< std::array<double, 4>, 4>& matrix_model_camera);
public:
